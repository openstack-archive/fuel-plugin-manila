...
class TestManilaIntegration(TestBasic):
    ...
    def manila_two_computes(self):
        """Check cluster deploy with Manila Plugin and two nodes with
        compute role.
    ...
    def manila_two_cinders(self):
        """Check cluster deploy with Manila Plugin and two nodes with cinder
        role.
    ...
    def manila_both_cinder_ceph(self):
        """Deploy a cluster using Ceph as a backend for block storage and
        cinder for other (image, object and ephemeral).
