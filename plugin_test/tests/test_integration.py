...
class TestManilaIntegration(TestBasic):
    ...
    def manila_controller_ha(self):
        ...
        self.env.make_snapshot("manila_controller_ha", is_make=True)

    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["manila_two_computes"])
    @log_snapshot_after_test
    def manila_two_computes(self):
        """Check cluster deploy with Manila Plugin and two compute role.
        ...
        self.env.make_snapshot("manila_two_computes", is_make=True)

    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["manila_two_cinders"])
    @log_snapshot_after_test
    def manila_two_cinders(self):
        """Check cluster deploy with Manila Plugin and two cinder roles.
        ...
        self.env.make_snapshot("manila_two_cinders", is_make=True)
    ...
    def manila_share_ha(self):
        ...
        self.env.make_snapshot("manila_share_ha", is_make=True)

    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["manila_data_ha"])
    @log_snapshot_after_test
    def manila_share_ha(self):
        """Check cluster deploy with Manila Plugin and Manila-data role.
    ...
    def manila_both_cinder_ceph(self):
        """Deploy a cluster using Ceph as a backend for block storage.
        ...
        self.env.make_snapshot("manila_both_cinder_ceph", is_make=True)

    @test(depends_on=[SetupEnvironment.prepare_slaves_3],
          groups=["manila_all_ceph"])
    @log_snapshot_after_test
    def manila_all_ceph(self):
        """Deploy a cluster using Ceph as a backend for all storage types.
        ...
        self.env.make_snapshot("manila_all_ceph", is_make=True)
    ...
    def manila_with_ceilometer(self):
        ...
        self.env.make_snapshot("manila_with_ceilometer", is_make=True)
    ...
    def manila_with_murano(self):
        ...
        self.env.make_snapshot("manila_with_murano", is_make=True)
    ...
    def manila_with_murano(self):
        ...
        self.env.make_snapshot("manila_with_sahara", is_make=True)
