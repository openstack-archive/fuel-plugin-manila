...
class ManilaTestClass(TestBasic):
    ...
    def manila_install(self):
        ...
        Scenario:
            ...
            9. Verify that plugin is removed, run command 'fuel plugins'.
        Duration: 20 min
    ...
    def manila_smoke(self):
        ...
        manila_image = plugin.upload_manila_image(self.ssh_manager.admin_ip,
            settings.MANILA_IMAGE_DEST_PATH)
        assert_true(
            manila_image,
    ...
    def manila_bvt(self):
        ...
        manila_image = plugin.upload_manila_image(
            self.ssh_manager.admin_ip, settings.MANILA_IMAGE_DEST_PATH)
        assert_true(
